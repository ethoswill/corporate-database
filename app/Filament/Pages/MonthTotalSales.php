...
class MonthTotalSales extends Page
{
    use WithFileUploads;
    ...
    protected static string $view = 'filament.pages.month-total-sales';
    ...
    {
        Route::get('/month-total-sales/{month}', static::class)
    ...
    protected function loadReportData(): void
    {
        ...
        $filePath = 'sales-reports/' . $this->month . '/total-sales-report.csv';

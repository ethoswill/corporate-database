...
class TopFranchiseeReport extends Page
{
    use WithFileUploads;
    ...
    protected static string $view = 'filament.pages.top-franchisee-report';
    ...
    {
        Route::get('/top-franchisee-report', static::class)
    ...
    {
        $filePath = 'sales-reports/top-franchisee-report.csv';

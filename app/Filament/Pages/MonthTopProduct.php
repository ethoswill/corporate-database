...
class MonthTopProduct extends Page
{
    use WithFileUploads;
    ...
    protected static string $view = 'filament.pages.month-top-product';
    ...
    {
        Route::get('/month-top-product/{month}', static::class)
    ...
    protected function loadReportData(): void
    {
        ...
        $filePath = 'sales-reports/' . $this->month . '/top-product-report.csv';

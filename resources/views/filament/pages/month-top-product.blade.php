<x-filament-panels::page>
    <div class="space-y-6 w-full" style="max-width: 100%; width: 100%;">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
            ...
            <span class="text-gray-900 font-medium">Top Product Report</span>
        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <!-- Total Row -->
                            <tr class="bg-green-50 dark:bg-green-900/20 font-bold border-t-2 border-b-2 border-gray-300 dark:border-gray-600">
                                @foreach($totalRow as $index => $cell)
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        @if($index > 0 && is_numeric($cell))
                                            <span class="text-green-600 dark:text-green-400">${{ number_format((float)$cell, 2) }}</span>
                                        @else
                                            <span class="text-green-600 dark:text-green-400">{{ $cell ?? '' }}</span>
                                        @endif
                                    </td>
                                @endforeach
                            </tr>
